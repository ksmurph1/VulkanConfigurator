...
foreach(_expectedTarget Folly::folly Folly::folly_deps)
...
set_target_properties(Folly::folly_deps PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "Threads::Threads;/usr/lib/libboost_filesystem.so;/usr/lib/libboost_program_options.so;/usr/lib/libboost_regex.so;/usr/lib/libboost_system.so;/usr/lib/libboost_thread.so;-pthread;/usr/lib/libboost_chrono.so;/usr/lib/libboost_date_time.so;/usr/lib/libboost_atomic.so;/usr/lib/x86_64-linux-gnu/libdouble-conversion.so;dl"
)
