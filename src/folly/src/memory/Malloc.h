...
//KM 02/13/20 don't include malloc.h if jemalloc.h is included because declaration clash
#pragma once
...
#include "detail/MallocImpl.h" /* nolint */
...
#if !(defined(USE_JEMALLOC) && defined(FOLLY_USE_JEMALLOC)) || FOLLY_SANITIZE && __has_include(<malloc.h>)
#include <malloc.h>
