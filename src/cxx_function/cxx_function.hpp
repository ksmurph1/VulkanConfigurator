...
class unique_function
    ...
    allocator_in * allocator=nullptr;
public:
    ...
    template <typename source,typename= typename std::enable_if< std::is_constructible< wrapper, source >::value>::type>
    unique_function( source && s, allocator_in const & alloc)
    noexcept(std::is_nothrow_constructible_v< wrapper, source &&, allocator_in const & >)
    {
       *allocator=alloc;
       wrapper::assign(s,*allocator);
    }
    ...
    allocator_in * get_allocator() const
    {
        return allocator;
    }
};
...
public:
    ...
    noexcept( std::is_nothrow_constructible< wrapper, source &&, allocator_in const & >::value )
        : wrapper( alloc, std::forward< source >( s )){}
