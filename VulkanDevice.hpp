	...
	struct VulkanDevice
	{
		...
		*/
		VkCommandPool createCommandPool(uint32_t queueFamilyIndex, VkCommandPoolCreateFlags createFlags = VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT)
		{
			...
			.flags = createFlags, .queueFamilyIndex = queueFamilyIndex};
		...
		*/
		void flushCommandBuffer(VkCommandBuffer commandBuffer, VkQueue queue, bool free = true)
		{
			...
			vks::initializers::submitInfo.commandBufferCount = 1;
			vks::initializers::submitInfo.pCommandBuffers = &commandBuffer;
			...
			// Submit to the queue
			VK_CHECK_RESULT(vkQueueSubmit(queue, 1, &vks::initializers::submitInfo, fence));
