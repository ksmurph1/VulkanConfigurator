...
public:
	...
	void prepare()
	{
		VulkanExampleBase::prepare(); // should be init phase
		prepareSynchronizationPrimitives(); // parallel should be init phase
		prepareVertices(USE_STAGING);  // -depends on log device and command pool
